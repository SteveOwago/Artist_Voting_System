    ...
    public function sendSMS($mobile_number,$message){
        ...
        if($mobile_number&&$message){
            ...
            $encodMessage = rawurlencode($message);
                ...
                $url = 'https://3.229.54.57/expresssms/Api/send_bulk_api?action=send-sms&api_key=Snh2SGFQT0dIZmFtcRGU9ZXBlcEQ=&to='.$mobile_number.'&from=EABL&sms='.$encodMessage.'&response=json&unicode=0&bulkbalanceuser=voucher';
